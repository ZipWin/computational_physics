...
module roots_seeker
    ...
    subroutine post(f, phi, x_init, epsilon1, epsilon2, file_name, root, iter, stat)
        implicit none
            ...
            do while (b <= right)
                ...
                if (can_converge) then
                    ...
                    if (trim(seeker) == "jacobi") then
                        ...
                        call post(f, phi, x_init, epsilon1, epsilon2, file_name, root, iter, is_converge)
...
program main
    ...
    do i = 1, root_num
        print "(a8, f16.6)", "root: ", roots(i)%value
        print "(a8, f16.6)", "error: ", roots(i)%error
